        ...
        <script language="javascript" type="text/javascript">
            ...
            function check_privilege() {
            	...
            	if(checkObjs.length == 0) {
            		$("#privilege_msg").text("请至少选择一个模块.").addClass("error_msg");
            	} else {
            		$("#privilege_msg").text("有效的选择.").removeClass("error_msg");
            	}
            }
            //保存成功的提示消息
            function showResult() {
            ...
            <form action="updateRole" method="post" class="main_form">
                ...
                <div class="input_info_high">
                    <div class="input_info_scroll">
                        <s:checkboxlist name="role.privilegeIds" list="privileges" listKey="id" listValue="name" onclick="check_privilege();"/>
                    </div>
                    <span class="required">*</span>
