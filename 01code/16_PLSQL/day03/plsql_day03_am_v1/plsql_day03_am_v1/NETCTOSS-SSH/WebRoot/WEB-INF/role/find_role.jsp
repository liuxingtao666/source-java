        ...
        <div id="main">
            <form action="" method="">
                    ...
                    <table id="datalist">
                        ...
                        <tr>
                            ...
                            <td>
                            	<!-- 循环角色权限数据，
                            		拼出权限名称字符串。
                            		本次循环过程中，栈顶是RolePrivilege。
                            		可以通过privilegeName，访问其
                            		getPrivilegeName()。
                            		status属性声明的是循环状态。 -->
                ...
                <div id="pages">
                	...
                	<s:else>
                		<a href="findRole?page=<s:property value="page-1"/>">上一页</a>
                	</s:else>
        	        
        	         <s:iterator begin="1" end="totalPage" var="k">
        	         	<s:if test="#k==page">
        	         		<a href="findRole?page=<s:property value="#k"/>" class="current_page"><s:property value="#k"/></a>
        	         	</s:if>
        	         	<s:else>
        	         		<a href="findRole?page=<s:property value="#k"/>"><s:property value="#k"/></a>
        	         	</s:else>
        	         </s:iterator>
                    ...
                    <s:else>
                    	<a href="findRole?page=<s:property value="page+1"/>">下一页</a>
                    </s:else>
                </div>
            </form>
        </div>
