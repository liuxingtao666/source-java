        ...
        <div id="main">  
            ...
            <form action="updateAccount" method="post" class="main_form">
                    ...
                    <div class="input_info">
                    	<s:textfield name="account.id" cssClass="readonly" readonly="true"/>
                    </div>
                    <div class="text_info clearfix"><span>姓名：</span></div>
                    <div class="input_info">
                    	<s:textfield name="account.realName"/>
                        <span class="required">*</span>
                        <div class="validate_msg_long error_msg">20长度以内的汉字、字母和数字的组合</div>
                    </div>
                    <div class="text_info clearfix"><span>身份证：</span></div>
                    <div class="input_info">
                    	<s:textfield name="account.idcardNo" cssClass="readonly" readonly="true"/>
                    </div>
                    <div class="text_info clearfix"><span>登录账号：</span></div>
                    <div class="input_info">
                    	<s:textfield name="account.loginName" cssClass="readonly" readonly="true"/>
                        <!--                
                    ...
                    <div class="input_info">
                    	<!-- 
                    		...
                    		不保存。
                    	 -->
                    	<s:textfield name="account.recommenderIdcardNo"/>
                       	<!-- 
                       		推荐人ID需要保存，因此需要
                       		使用UI标签回显。
                       	 -->
                        <s:textfield name="account.recommenderId"/>
                    ...
                    <div class="input_info">
                    	<s:textfield name="account.email" cssClass="width200"/>
                        <div class="validate_msg_medium">50长度以内，合法的 Email 格式</div>
                    </div> 
                    <div class="text_info clearfix"><span>职业：</span></div>
                    <div class="input_info">
                    	<s:select name="account.occupation" list="#{'0':'干部','1':'学生','2':'技术人员','3':'其他'}" headerKey="" headerValue="请选择"/>
                    </div>
                    <div class="text_info clearfix"><span>性别：</span></div>
                    <div class="input_info fee_type">
                    	<s:radio name="account.gender" list="#{'0':'男','1':'女'}" onclick="feeTypeChange(this.value);"/>
                    </div> 
                    ...
                    <s:hidden name="account.loginPassword"/>
                    <s:hidden name="account.status"/>
                    <s:hidden name="account.createDate"/>
                    <s:hidden name="account.pauseDate"/>
                    <s:hidden name="account.closeDate"/>
                    <s:hidden name="account.lastLoginTime"/>
                    <s:hidden name="account.lastLoginIp"/>
