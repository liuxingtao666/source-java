--Step0：创建一张表，包含三列不同的数字类型
drop table Tnumber_你名字全拼;
...
update TNUMBER_你名字全拼 set cNum3_2=19995;
--Step4：更新第一行，保存99995到number(3,-2)——出错，四舍五入为100000，超过3-(-2)=5位整数
update TNUMBER_你名字全拼 set cNum3_2=99995;

--Step5：更新第一行，保存0.0009到number(1,3)——四舍五入为0.001
update TNUMBER_你名字全拼 set cNum13=0.0009;
--Step6：更新第一行，保存0.0099到number(1,3)——出错，四舍五入为0.01，不满足精度要求
update TNUMBER_你名字全拼 set cNum13=0.0099;
